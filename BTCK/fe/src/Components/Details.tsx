      ...
      <section className="container pt-4 mx-auto w-full bg-bgColor">
        <section className="px-6 flex flex-row justify-between">
          ...
          <div className="flex flex-wrap mt-4 lg:mb-4 mb-8">
            ...
            <button
              value="Vietnamese"
              onClick={() => handleBtns('Vietnamese')}
              className={`mr-2 text-brandColor border-brandColor border-2 py-1 md:w-24 h-10 rounded-lg text-lg ${activeTab === 'Vietnamese' ? 'bg-brandColor outline-none text-white' : ''
                }`}
            >
              Vietnamese
            </button>
